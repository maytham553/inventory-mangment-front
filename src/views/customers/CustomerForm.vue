<template>
  ...
  >
  <h1 class="text-secondary text-4xl mb-8 font-bold"> إضافة عميل</h1>
    ...
    <div class="bg-gray-100 sm:w-[400px] p-5 rounded-2xl">
      ...
      <div class="mb-4">
        <label for="email" class="block text-gray-700 m-1"
      ...
      <div class="mb-4">
        <label for="governorate_id" class="block text-gray-700 m-1"
          >المحافظة</label
        >
        <select
          id="governorate_id"
