    ...
    >
      ...
      >
        ...
        <input
          ...
          autocomplete="email"
          required
          class="pr-4 appearance-none border focus:ring-blue-500 focus:border-blue-500 focus:outline-none bg-gray-200 w-full h-10 pl-5 rounded-xl text-gray-500 text-sm placeholder:text-gray-500"
