...
<template>
    ...
    <!-- <div class="h-screen col-span-1 p-5 bg-blue-500 flex flex-col justify-center items-center">
        ...
        <div class="h-screen col-span-2 flex flex-col justify-center items-center pt-16">
            ...
            <h1 class="text-blue-500 text-4xl font-bold ">تسجيل الدخول</h1>
            <p class="my-5  text-gray-500">
                أدخل معلوماتك للدخول الى حسابك
            </p>
            <form @submit.prevent="login" class="w-full mt-10 flex flex-col md:w-2/5 px-10 justify-center items-center">
                <input type="hidden" name="remember" value="true">

                <input id="email-address" v-model="email" name="email" type="email" autocomplete="email" required
                    class="pr-4 appearance-none border  focus:ring-blue-500 focus:border-blue-500 focus:outline-none 
                                                                                                                                                    bg-gray-200  w-full h-10 pl-5 rounded-xl text-gray-500 text-sm placeholder:text-gray-500"
                ...
                <button type="submit" :disabled=auth.status.loading
                    class="group relative  w-full flex justify-center gap-3 py-2 px-4 border border-transparent text-md font-medium rounded-2xl text-gray-100 bg-blue-500 hover:bg-blue-700 focus:outline-none ">
                    تسجيل الدخول
