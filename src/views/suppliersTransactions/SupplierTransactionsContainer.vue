<template>
  <div class="h-full w-full flex flex-col justify-between items-center">
    ...
    <div
      v-if="supplierTransactionsStatus.loading"
    ...
    <div
      v-if="supplierTransactionsStatus.success && !supplierTransactions.length"
      class="flex justify-center items-center h-full"
    >
...
onMounted(async () => {
  await SupplierTransactionsStore.fetchSupplierTransactionsBySupplierId(
    props.supplierId,
    1
  );
});
