                ...
                <div class="md:rounded-b-md  bg-white">
                    ...
                    <div class="space-y-3  flex flex-col justify-center  items-center m-10">
                        ...
                        <div class="flex justify-between w-72 bg-gray-200 p-2 rounded-lg">
                            ...
                            <p class="text-gray-500 text-sm"> {{ purchase.discount_amount }} </p>
                        </div>
                        <div class="flex justify-between w-72 bg-gray-200 p-2 rounded-lg">
                            <div>
                    ...
                    <table class="w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="(rawMaterial, index) in purchase.raw_materials" :key="rawMaterial.id">
                                ...
                                <td class="px-3 py-5 space-x-1 flex items-center">{{ rawMaterial.name }}</td>
                                <td class="px-3 text-gray-600 truncate">{{ rawMaterial.quantity }} </td>
                                <td class="px-3 text-gray-600 truncate"> {{ rawMaterial.cost }} </td>
                                <td class="px-3 text-gray-600 truncate"> {{ rawMaterial.discount_amount }} </td>
