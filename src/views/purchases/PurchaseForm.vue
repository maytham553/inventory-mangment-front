        ...
        <div class="h-1/3 overflow-hidden flex  gap-1 ">
            <div class="flex w-1/2 flex-col gap-1">
                ...
                <div class="flex  items-center w-72  justify-between  ">
                    ...
                    <input placeholder="مبلغ الخصم" type="number" id="discountAmount" v-model="purchase.discount_amount"
            ...
            <div class="flex w-1/2 flex-col gap-1 justify-between">
                <div class="flex flex-col gap-1">
                    <div class="flex  items-center w-72  justify-between  ">
                        ...
                        <select id="status" v-model="purchase.status" required
                            class="form-select   p-1 rounded-lg bg-gray-200">
                            <option value="" disabled selected>اختر الحالة</option>
                            <option v-for="status in PurchaseStatus" :key="status" :value="status">
                                {{ status }}
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="flex  items-center w-72  justify-between  ">
                        ...
                        <textarea placeholder="ملاحظات" id="note" v-model="purchase.note"
