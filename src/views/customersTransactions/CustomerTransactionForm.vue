...
import { TransactionType, type Status, type CustomerTransaction } from '../../Types';
...
const props = defineProps({
    transaction: {
        type: Object as () => CustomerTransaction,
        required: false
    },
    status: {
...
const handleSubmit = async () => {
    ...
    formData.value = { ...props.transaction } as CustomerTransaction;
};
</script>