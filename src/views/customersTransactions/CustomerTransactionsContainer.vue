<template>
    ...
    <PaginationItems v-if="!customerTransactionsStatus.error"
        :currentPage="CustomerTransactionsStore.getCustomerTransactionsPagination.currentPage"
        :totalPages="CustomerTransactionsStore.getCustomerTransactionsPagination.lastPage"
...
const customerTransactionStatus = storeToRefs(CustomerTransactionsStore).customerTransactionStatus;
const customerTransactionsStatus = storeToRefs(CustomerTransactionsStore).customerTransactionsStatus;
const customerTransactions = storeToRefs(CustomerTransactionsStore).customerTransactions;
...
onMounted(async () => {
    await CustomerTransactionsStore.fetchCustomerTransactionsByCustomerId(props.customerId, 1);
});
