<template>
    <div>
        <div class="flex items-center justify-center w-[284px] m-2 rounded-lg bg-gradient-to-r from-[#29ADB2] via-red-400 to-[#C5E898] rounded-tr-[20%] h-[194px]  bg-black">
            <div class="pb-2 pr-3 pt-3  w-[280px] h-[190px] bg-gray-100 drop-shadow-lg 
    hover:drop-shadow-xl rounded-lg rounded-tr-[20%] flex flex-col items-center">
