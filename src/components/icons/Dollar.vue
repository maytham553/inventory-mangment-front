<template>
    <svg :class="iconClasses" :width="iconWidth" :height="iconHeight" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 235.517 235.517" xml:space="preserve" fill="cuurentColor">
