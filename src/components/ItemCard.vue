<template>
  <div
    class="p-3 flex border flex-col   items-stretch justify-between w-[330px]
     bg-white hover:drop-shadow-xl rounded-lg"
  >
    <div>
      <h2 class="text-right pr-4 text-secondary font-bold text-2xl mb-5">
        {{ name }}
      </h2>
    ...
    <div class="flex mt-5 justify-evenly items-center">
      <button
        @click="updateHandler"
        class="bg-secondary hover:bg-primary text-white font-bold py-2 px-3 rounded-lg flex gap-2 items-center"
      >
        تعديل
